...
<div>
<a href="https://www.rnaseqcore.vet.cornell.edu/" target="_blank" class="trex-logo"> <img src="/Users/fa286/Documents/trex-extended-logo.png" 
style=
"position:absolute; 
top:0px; 
right:0;
...
## Multiqc HTML
The multiqc html summarises the alignment statistics along with the summary of raw counts generated via [STAR](https://academic.oup.com/bioinformatics/article/29/1/15/272537); 
...
## sampleCluster {.tabset  .tabset-fade .tabset-pills}
### Clust
...
### Clust-Heart
![](figures/cluster-hrt.png){width=800px}

An euclidean distance is computed between samples, and the dendrogram is built upon the Ward criterion. We expect this dendrogram to group replicates and separate biological conditions.

### Clust-Lung
![](figures/cluster-lung.png){width=800px}

An euclidean distance is computed between samples, and the dendrogram is built upon the Ward criterion. We expect this dendrogram to group replicates and separate biological conditions.

## principalComponents {.tabset  .tabset-fade .tabset-pills}
### PCA 
...
### PCA Heart Samples
![](figures/PCA-hrt.png){width=1200px}

Another way of visualizing the experiment variability is to look at the first principal components of the PCA. On this figure, the first principal component (PC1) is expected to separate samples from the different biological conditions, meaning that the biological variability is the main source of variance in the data.

### PCA Lung Samples
![](figures/PCA-lung.png){width=1200px}

Another way of visualizing the experiment variability is to look at the first principal components of the PCA. On this figure, the first principal component (PC1) is expected to separate samples from the different biological conditions, meaning that the biological variability is the main source of variance in the data.

### PCA Lung Samples w/o Outliers
![](figures/PCA-lung2.png){width=1200px}
